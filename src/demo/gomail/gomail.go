...
func InitEmail(ep *EmailParam) {
	...
	m.SetAddressHeader("From", fromEmail, "大和子")
}
...
func main() {
	...
	serverPort := 465
	fromEmail := "1368667276@qq.com"     //发件人邮箱
	fromPasswd := "fjwaqqajdhsmjdif"    //授权码

	myToers := "1368667276@qq.com,1353859575@qq.com" // 收件人邮箱，逗号隔开
	myCCers := "" //"readchy@163.com"

	subject := "这是主题"
	body := `<h1>好像成功了，有点意思</h1><br>
             你不学习的呀？ <a href = "https://docs.qq.com/doc/DWlVXeHBTdFZNYWdS">我们的学习计划</a>
             `
